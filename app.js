...
async function executeRegistration(formData, buttonId, buttonText) {
  ...
  try {
    ...
    const payload = {
      ...
      user_type: formData.accountType === 'admin' ? 'college' : formData.accountType,
...
async function loadCollegeData() {
  ...
  try {
    ...
    if (currentUser.userType === 'college' && currentUser.college !== '学工处') query = query.eq('college', currentUser.college);
...
async function loadReviewData() {
  ...
  try {
    ...
    if (currentUser.userType === 'college' && currentUser.college !== '学工处') {
        query = query.eq('college', currentUser.college);
    }
